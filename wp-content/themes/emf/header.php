...
<div class="site"  style="background-image: url('<?php the_field('choose_the_image_for_background_on_current_page'); ?>')">
    ...
    <?php if(is_front_page()): ?>
        <!-- site__video -->
        <div class="site__video">
            <video id="movie" autoplay poster="<?= DIRECT; ?>/img/index-video-bg.jpg" loop>
                <source src="<?= DIRECT; ?>/video/index-video.mp4" />
                <source src="<?= DIRECT; ?>/video/index-video.webm" type='video/webm; codecs="vp8, vorbis"' />
                <source src="<?= DIRECT; ?>/video/index-video.ogv" type='video/ogg; codecs="theora, vorbis"' />
...
<!--            </a>-->
    ...
    <div class="top-links">
        ...
        <div class="top-links__item">
            <a href="<?= get_permalink(21); ?>">request a callback</a>
        </div>
        <div class="top-links__item">
            <a href="<?= get_permalink(42); ?>">request appointment</a>
        </div>
        <div class="top-links__item">
            <a href="<?= get_permalink(40); ?>">EMERGENCY SERVICE</a>
        </div>
    </div>
    <!-- /top-links -->